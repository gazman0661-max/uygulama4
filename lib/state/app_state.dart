...
class AppState extends ChangeNotifier {
  ...
  /// dönüleceğini bundan bulur. Builder Pro / eski kayıtlarda null olabilir.
  ...
  void setQtFormData(Map<String, dynamic> data, {ProjectKind? kind}) {
    ...
    notifyListeners();
    _savePrefString(_qtFormDataPrefsKey, jsonEncode(data));
  ...
  Future<void> detachQtSlotForNewProject() async {
    ...
    await prefs.remove(_qtFormDataPrefsKey);
  ...
  Future<void> _loadFromPrefs() async {
    ...
    final qtFormDataRaw = prefs.getString(_qtFormDataPrefsKey);
  ...
  Future<void> openQtProject(String id) async {
    ...
    await prefs.setString(_qtFormDataPrefsKey, jsonEncode(qtFormData));
  ...
  /// noktada kaydedilmiş olur, bkz. preview_screen.dart/builder_screen.dart).
