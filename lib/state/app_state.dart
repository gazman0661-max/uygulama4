...
class AppState extends ChangeNotifier {
  ...
  Future<bool> _syncProjectToCloudIfSignedIn(SiteProject project) async {
    ...
    try {
      ...
      // Bulut güncellemesi başarısız oldu (internet yok, geçici hata vb.)
      // — yerel kayıt zaten yapıldı, kullanıcı akışını bloklamıyoruz ama
      // bu proje id'sini kalıcı olarak "bekleyenler" kuyruğuna yazıyoruz ki
      // uygulama kapansa/silinse bile bir sonraki girişte otomatik
      // tekrar denensin (aksi halde veri sessizce kaybolabiliyordu).
