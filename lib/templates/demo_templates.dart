...
class TemplateDemoConfig {
  ...
  /// 07.09.2026 eklendi (kanka isteği) — bio_link/business_card'ın hero
  /// kavramı yok (generateBioLinkHtml/generateBusinessCardHtml hiç
  /// heroBlockHtml çağırmıyor), bu yüzden onlarda LayoutStylePickerField
  /// hiç gösterilmez (bkz. template_preview_screen.dart).
  final bool showLayoutStyle;

  /// 07.09.2026 eklendi (kanka isteği) — ön izleme ilk açıldığında hangi
  /// hero düzeniyle başlasın. Çoğu şablon 'centered' (form ekranlarındaki
  /// varsayılanla AYNI), Emlak Sitesi ise tarihsel olarak hep 'editorial'
  /// idi (bkz. real_estate_html_generator.dart) — o görünümü korumak için
  /// demoRealEstate bunu override ediyor.
...
final TemplateDemoConfig demoKuafor = TemplateDemoConfig(
  title: 'Kuaför / Berber',
  buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generateBusinessSiteHtml(
    name: 'Ayşe Kuaför',
    ...
    density: density,
    heroLayoutStyle: layoutStyle,
    schemaType: 'HairSalon',
  ),
  openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => KuaforFormScreen(
    initialData: {
...
final TemplateDemoConfig demoKafe = TemplateDemoConfig(
  title: 'Kafe / Restoran',
  buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generateCafeHtml(
    name: 'Kahve Durağı',
  ...
  openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => KafeFormScreen(
    initialData: {
      'selectedTheme': themeId,
      'fontPackageId': fontPackageId,
      'typeDensity': density,
...
final TemplateDemoConfig demoKlinik = TemplateDemoConfig(
  title: 'Klinik / Sağlık',
  buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generateClinicHtml(
  ...
  openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => ClinicFormScreen(
    initialData: {
      'selectedTheme': themeId,
      'fontPackageId': fontPackageId,
      'typeDensity': density,
...
TemplateDemoConfig _bizDemo({
  ...
  return TemplateDemoConfig(
    ...
    openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => formBuilder({
      'selectedTheme': themeId,
      'fontPackageId': fontPackageId,
      'typeDensity': density,
      'heroLayoutStyle': layoutStyle,
...
TemplateDemoConfig _extendedDemo({
  ...
  return TemplateDemoConfig(
    title: title,
    buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generateExtendedBusinessSiteHtml(
      businessName: businessName,
...
TemplateDemoConfig _portfolioDemo({
  ...
  return TemplateDemoConfig(
    title: title,
    buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generatePortfolioHtml(
      name: name,
      title: roleTitle,
...
final TemplateDemoConfig demoBioLink = TemplateDemoConfig(
  ...
  showLayoutStyle: false,
  buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generateBioLinkHtml(
    name: 'Ada Yılmaz',
  ...
  openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => BioLinkFormScreen(
...
final TemplateDemoConfig demoBusinessCard = TemplateDemoConfig(
  ...
  showTypography: false,
  showLayoutStyle: false,
  buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) => generateBusinessCardHtml(
    name: 'Kaan Öztürk',
    title: 'Kurucu Ortak',
  ...
  openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => BusinessCardFormScreen(
    initialData: {'selectedTheme': themeId},
  ),
);
...
final TemplateDemoConfig demoRealEstate = TemplateDemoConfig(
  title: 'Emlak Sitesi',
  initialLayoutStyle: 'editorial',
  buildHtml: ({required themeId, required fontPackageId, required density, required layoutStyle}) {
  ...
  openForm: ({required themeId, required fontPackageId, required density, required layoutStyle}) => RealEstateFormScreen(
    initialData: {
      'selectedTheme': themeId,
      'fontPackageId': fontPackageId,
      'typeDensity': density,
