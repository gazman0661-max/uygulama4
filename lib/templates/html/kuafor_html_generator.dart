...
String generateBusinessSiteHtml({
  ...
  // 06.09.2026 eklendi (kanka isteği) — hero düzeni seçimi (bkz.
  ...
  // 15.09.2026 eklendi (kanka isteği) — Bölüm Sırala/Gizle. Orta bloklar
  // artık bu listeye göre diziliyor; null/boş verilirse (eski çağrılar,
  // eski kayıtlı projeler) kBusinessSiteDefaultOrder ile AYNEN eskisi gibi
  // davranır — geriye dönük uyumlu, mevcut sitelerde HİÇBİR ŞEY DEĞİŞMEZ.
  // Hero ve İletişim/Talep formu kasıtlı olarak bu listenin DIŞINDA, hep
  // sabit (bkz. section_registry.dart).
  List<String>? sectionOrder,
}) {
  // 11.09.2026 eklendi — bkz. shared_html_blocks.dart > shapeStyleOf
  // dokümanı: kart köşe/gölge "mood"unu işletme adına göre otomatik,
  // deterministik seç (kullanıcıya yeni bir seçim yüklemeden).
  ...
  // 15.09.2026 eklendi (kanka isteği) — Bölüm Sırala/Gizle: orta bloklar
  // artık sabit if-zinciri yerine bir id->builder haritası + sectionOrder
  // listesine göre diziliyor. Her builder aynı eski koşulu (boşsa/yoksa
  // null döner, hiç yazılmaz) birebir korur — davranış AYNI, sadece SIRA
