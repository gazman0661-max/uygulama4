...
Map<String, String> generateClinicSite({
  ...
  final navLinks = [
    ...
    if (services.isNotEmpty || practitioner != null) {'label': servicesPageLabel, 'href': 'hizmetler.html'},
  ...
  homeBody.writeln(contactBlockHtml(title: labels['contact']!, phone: phone, whatsapp: whatsapp, instagram: instagram, lang: lang));
  ...
  // --- hizmetler.html (uzmanlık alanları + hekim profili) ---
  if (services.isNotEmpty || practitioner != null) {
    ...
    svcBody.writeln(contactBlockHtml(title: labels['contact']!, phone: phone, whatsapp: whatsapp, instagram: instagram, lang: lang));
  ...
  apptBody.writeln(contactBlockHtml(title: '', phone: phone, whatsapp: whatsapp, instagram: instagram, lang: lang));
