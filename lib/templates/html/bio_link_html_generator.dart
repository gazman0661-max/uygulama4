...
String generateBioLinkHtml({
  ...
  // 18.09.2026 eklendi (kanka isteği) — bio_link_form_screen.dart artık
  // TypographyPickerField gösteriyor; bkz. shared_html_blocks.dart ->
  // [fontPackageOf]/[resolveFontPackage]. Diğer sektör generator'larıyla
  // BİREBİR AYNI parametre ismi/varsayılanı, çağıran kod tutarlı kalsın.
...
/// 17.09.2026 eklendi ('Özel Tema' B seçeneği) — bu dosyanın kendi
/// tema şeması (background/btnBg/btnText/btnBorder/radius) [siteThemes]
/// ile birebir aynı değil, bu yüzden [resolveTheme] doğrudan
/// kullanılamıyor; kullanıcının bg/text/cardBg/accent girdisini bu şemaya
/// eşler. [autoContrastTextColor] ile buton yazısı, kullanıcı hangi
/// vurgu rengini seçerse seçsin okunaklı kalır (bkz. shared_html_blocks.dart).
