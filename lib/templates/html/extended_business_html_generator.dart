...
String generateExtendedBusinessSiteHtml({
  ...
  if (beforeAfterGallery.isNotEmpty) {
    body.writeln(galleryBlockHtml(title: beforeAfterTitle, images: beforeAfterGallery, beforeAfter: true));
  } else if (gallery.isNotEmpty) {
    body.writeln(galleryBlockHtml(title: resolvedGalleryTitle, images: gallery));
  }
