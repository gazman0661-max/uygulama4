...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .video-embed-wrap { position: relative; width: 100%; margin: 0 auto; border-radius: 16px; overflow: hidden; background: #0b0b0b; box-shadow: 0 14px 34px rgba(0,0,0,0.20); }
  ...
  .contact-btn { padding: 12px 20px; border-radius: 10px; text-decoration:none; font-weight:600; color:var(--sitora-accent-text); background:var(--sitora-accent); transition: transform 0.18s ease, box-shadow 0.18s ease; display:inline-block; }
  ...
  .randevu-form input, .randevu-form textarea { padding: 12px; border-radius: 8px; border: 1px solid var(--sitora-border); background:var(--sitora-card-bg); color:var(--sitora-text); font-size:15px; }
  .randevu-form button { padding: 14px; border:none; border-radius: 8px; background:var(--sitora-accent); color:var(--sitora-accent-text); font-weight:700; cursor:pointer; }
  .sitora-lead-form { display:flex; flex-direction:column; gap: 12px; max-width: 420px; margin-top: 18px; }
  .sitora-lead-form input, .sitora-lead-form textarea { padding: 12px; border-radius: 8px; border: 1px solid var(--sitora-border); background:var(--sitora-card-bg); color:var(--sitora-text); font-size:15px; font-family: inherit; }
  .sitora-lead-form button { padding: 14px; border:none; border-radius: 8px; background:var(--sitora-accent); color:var(--sitora-accent-text); font-weight:700; cursor:pointer; }
  ...
  .faq-item { border:1px solid var(--sitora-border); background:var(--sitora-card-bg); border-radius:10px; padding: 4px 16px; }
  ...
  .testimonial-card { border:1px solid var(--sitora-border); background:var(--sitora-card-bg); border-radius:14px; padding:20px; }
  ...
  .pkg-card { border:1px solid var(--sitora-border); background:var(--sitora-card-bg); border-radius:14px; padding:20px; transition: transform 0.2s ease, box-shadow 0.2s ease; }
  ...
  .contact-form input, .contact-form textarea { padding:12px; border-radius:8px; border:1px solid var(--sitora-border); background:var(--sitora-card-bg); color:var(--sitora-text); font-size:15px; }
  .contact-form button { padding:14px; border:none; border-radius:8px; background:var(--sitora-accent); color:var(--sitora-accent-text); font-weight:700; cursor:pointer; }
  ...
  .property-card { border-radius:12px; overflow:hidden; border:1px solid var(--sitora-border); background:var(--sitora-card-bg); text-decoration:none; color:inherit; display:block; }
  ...
  .vcard-btn { display:inline-block; padding:12px 24px; border-radius:10px; background:var(--sitora-accent); color:var(--sitora-accent-text); text-decoration:none; font-weight:700; margin-top:16px; }
