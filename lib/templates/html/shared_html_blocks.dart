...
String leadFormMarkup({String lang = 'tr', String siteName = ''}) {
  ...
  (function(){
    ...
    var PROJECT_ID = ${_jsStringLiteral(AppConfig.firebaseProjectId)};
    form.addEventListener('submit', function(e){
      ...
      var body = {
        fields: {
          ownerId: { stringValue: cfg.ownerUid || '' },
          siteId: { stringValue: cfg.siteId || '' },
          siteName: { stringValue: cfg.siteName || SITE_NAME || '' },
          name: { stringValue: name },
          phone: { stringValue: phone },
          message: { stringValue: message },
          source: { stringValue: 'site_form' },
          read: { booleanValue: false },
          createdAt: { timestampValue: new Date().toISOString() }
        }
      };
      fetch('https://firestore.googleapis.com/v1/projects/' + PROJECT_ID + '/databases/(default)/documents/leads', {
        method: 'POST',
