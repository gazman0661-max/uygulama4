...
<section class="section qr-menu-section" style="text-align:center; padding-top:0;">
  ...
  menuBody.writeln(contactBlockHtml(title: labels['reservationOrder']!, phone: phone, whatsapp: whatsapp, instagram: instagram, googleReviewLink: googleReviewLink, lang: lang));
  ...
  if (gallery.isNotEmpty) {
    ...
    style: galleryStyle,title: labels['gallery']!, images: gallery));
    galleryBody.writeln(contactBlockHtml(title: labels['contact']!, phone: phone, whatsapp: whatsapp, instagram: instagram, googleReviewLink: googleReviewLink, lang: lang));
