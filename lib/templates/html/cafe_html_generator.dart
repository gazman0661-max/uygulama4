  ...
  final middleBuilders = <String, String? Function()>{
    ...
    'menu': () {
      ...
      if (menuCategories.isNotEmpty) {
        buf.writeln(menuBlockHtml(title: labels['menu']!, categories: menuCategories));
      }
      if (menuUrl != null) {
        buf.writeln('''
  ...
  final homeMiddleBuilders = <String, String? Function()>{
    ...
    'menu': () {
      ...
      if (menuCategories.isNotEmpty) {
        ...
        buf.writeln(menuBlockHtml(title: labels['menuHighlights']!, categories: [menuCategories.first]));
        buf.writeln('''
