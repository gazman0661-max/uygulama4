...
<section class="section qr-menu-section" style="text-align:center;">
  ...
  if (gallery.isNotEmpty) {
    body.writeln(galleryBlockHtml(title: labels['gallery']!, images: gallery));
  }
...
<section class="section qr-menu-section" style="text-align:center; padding-top:0;">
  ...
  menuBody.writeln(contactBlockHtml(title: labels['reservationOrder']!, phone: phone, whatsapp: whatsapp, instagram: instagram, lang: lang));
  ...
  if (gallery.isNotEmpty) {
    ...
    galleryBody.writeln(galleryBlockHtml(title: labels['gallery']!, images: gallery));
    galleryBody.writeln(contactBlockHtml(title: labels['contact']!, phone: phone, whatsapp: whatsapp, instagram: instagram, lang: lang));
