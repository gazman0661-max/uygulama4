...
<section class="section" style="text-align:center;">
  ...
  final reviewButtonHtml = (agentGoogleReviewLink != null && agentGoogleReviewLink.trim().isNotEmpty)
      ? '<div style="text-align:center;margin-top:8px;"><a class="contact-btn review" target="_blank" href="${escapeHtml(agentGoogleReviewLink.trim())}">${escapeHtml(siteLabels(lang)['googleReviewButton']!)}</a></div>'
      : '';
...
String generateListingDetailHtml({
  ...
  body.writeln(contactBlockHtml(title: '', phone: agentPhone, whatsapp: agentWhatsapp, googleReviewLink: agentGoogleReviewLink, lang: lang));
