...
String generateListingListHtml({
  ...
  // (emlak) tarafına da eklendi. Sadece testimonials/faq'i kapsar —
  // property grid/hero/iletişim bu listenin dışında, her zaman sabit
  // kalır (bkz. section_registry.dart > kRealEstateDefaultOrder).
...
<section class="section" style="text-align:center;">
  ...
  // 15.09.2026 eklendi (kanka isteği) — sabit if-zinciri yerine
  // section_registry.dart'taki genel desen: id -> içerik üreten fonksiyon
  // map'i + effectiveOrder listesine göre for döngüsü. Listede olmayan
  // (kullanıcının kapattığı) id hiç yazılmaz.
  ...
  for (final sectionId in effectiveOrder) {
    ...
    if (html != null) extraSections.writeln(html);
  }
...
Map<String, String> generateRealEstateSite({
  ...
  List<Map<String, dynamic>> testimonials = const [],
  bool includeLeadForm = true, // 05.09.2026 eklendi
  List<String>? sectionOrder, // 15.09.2026 eklendi (kanka isteği)
}) {
