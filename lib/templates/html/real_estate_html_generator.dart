...
<section class="section" style="text-align:center;">
  ...
  <p style="color:#888;">${escapeHtml(tagline)}</p>
</section>
${propertyCardGridHtml(listings: cardData)}''';

  return wrapPageHtml(pageTitle: agentName, bodyHtml: body, accentColor: accentColor);
}
...
String generateListingDetailHtml({
  ...
  return wrapPageHtml(pageTitle: title, bodyHtml: body.toString(), accentColor: accentColor);
}
