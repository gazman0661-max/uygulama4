...
///
/// DÖRT FARKLI SATIN ALMA MODELİ, TEK TİP ÜRÜNLE (consumable) ÇÖZÜLÜYOR:
/// Play Billing'de bir "non-consumable" (managed) ürün hesap başına SADECE
/// BİR KERE satın alınabilir ve bir daha asla tekrar satılamaz. Bizim dört
/// akışımızın da (rozet kaldırma, site yayın hakkı, özel domain bağlama,
/// puan paketi) hepsi AYNI ürünün BİRDEN FAZLA kez satın alınabilmesini
...
/// fazla sitesine ayrı ayrı özel domain bağlayabilmeli). Bu yüzden DÖRDÜ DE
