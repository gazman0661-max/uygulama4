...
/// [chatContext] varsa (sohbetten açıldıysa) son kullanıcı isteği + son AI
...
class _ReportDialogContentState extends State<_ReportDialogContent> {
  ...
  Future<void> _send() async {
    ...
    if (userDetails.isEmpty) {
      showAppPopup(context, message: 'Lütfen kısa bir açıklama yazınız.', icon: '⚠️');
      return;
    }
    ...
    var fullDetails =
        '[${widget.source == ReportSource.preview ? "ÖN İZLEME / ÜRETİLEN SİTE" : "AI CHAT"}] $userDetails';
    ...
    try {
      ...
      showAppPopup(context,
          message: 'Bildirimin bize ulaştı, teşekkürler! En kısa sürede inceleyeceğiz. 🙏',
          icon: '✅');
