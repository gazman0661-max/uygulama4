...
/// Giriş yapılmamışsa bir bottom sheet açar: e-posta + şifre alanları,
/// "Giriş Yap" / "Kayıt Ol" arası geçiş ve "Şifremi Unuttum". Giriş
/// başarılıysa true, vazgeçilirse false döner.
///
...
class _LoginGateSheetState extends State<_LoginGateSheet> {
  ...
  // butonu gösterilir (bkz. _resendVerification). Mod/alan değişince
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_mode == _Mode.signUp) {
        ...
        // alınır. Sheet'i KAPATMIYORUZ; kullanıcı e-postasını doğrulayıp
        // aynı sheet üzerinden (Giriş Yap moduna geçerek) tekrar dener.
      ...
      setState(() {
        _loading = false;
        _info = e.message;
        _mode = _Mode.signIn; // doğrulayınca buradan giriş yapacak
      });
  ...
  /// "Doğrulama e-postasını tekrar gönder" — sadece [_needsVerification]
  /// true iken (yani şifre doğru ama e-posta doğrulanmamışken) gösterilir.
