...
Future<bool> showPublishPaywallSheet(
  ...
  // SAVUNMA KATMANI: preview_screen.dart > _publishSite bu sheet'i zaten
  // requireLogin'den geçtikten SONRA açıyor — ama "yayınlama girişe
  // bağlıdır" kuralının ileride başka bir çağıran tarafından atlanmasını
  // önlemek için kontrol burada da tekrarlanır. Giriş zaten yapılmışsa
  ...
  AnalyticsService.logPaywallShown(trigger: 'publish_paywall');
