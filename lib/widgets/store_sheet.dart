        ...
        child: Padding(
          ...
          child: Column(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      en
                          ? 'A subscription OR connecting your own domain removes the badge AND unlocks: lead inbox, full gallery, map, lead form, Google review button + Google Business Profile Setup Wizard, visitor stats, Google Search Console connection. These are locked only on the free plan. To use them, open the relevant site from My Projects and update it via the "Edit" button; the Search Console connection is set from the "Search Console" button on the site\'s card in My Projects (no republish needed). The wizard does not create your Google profile — Google does, with your account; it prepares your details, guides you through Google\'s free sign-up and connects your review link to your site.'
                          : 'Abonelik VEYA kendi domainini bağlamak, rozeti kaldırmanın YANI SIRA şunları da açar: Talep Kutusu, tam galeri, harita, talep formu, Google yorum butonu + Google İşletme Profili Kurulum Sihirbazı, ziyaretçi sayısı, Google Search Console bağlantısı. Bunlar sadece ücretsiz planda kilitlidir. Kullanmak için ilgili siteyi Projelerim ekranından açıp "Düzenle" butonuyla güncellemen gerekir; Search Console bağlantısı ise Projelerim\'deki site kartında bulunan "Search Console" butonundan yapılır (yeniden yayınlamak gerekmez). Sihirbaz Google profilini senin yerine açmaz — profili Google senin hesabınla açar; sihirbaz bilgilerini hazırlar, Google\'ın ücretsiz kayıt ekranına yönlendirir ve yorum linkini sitene bağlar.',
                      style: TextStyle(
                        color: subtleColor,
                        fontFamily: 'monospace',
                        fontSize: 11.5,
            ...
            _StoreRow(
              ...
              subtitle: en
                  ? 'Account-wide, auto-renewing monthly plans — bundles a site quota + custom-domain quota with the badge/lock unlocks above, including the Google Business Profile Setup Wizard and the Google Search Console connection. See plan comparison and pricing.'
                  : 'Hesap genelinde, otomatik yenilenen aylık paketler — yukarıdaki rozet/kilit açımlarını (Google İşletme Profili Kurulum Sihirbazı ve Google Search Console bağlantısı dahil) bir site kotası + domain kotasıyla paketler. Paket karşılaştırması ve fiyatları gör.',
