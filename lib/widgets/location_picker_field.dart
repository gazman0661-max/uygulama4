...
class _LocationPickerFieldState extends State<LocationPickerField> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context)
            .showSnackBar(SnackBar(content: Text('Adres aranamadı: $e')));
      }
    } finally {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text('Konum', style: TextStyle(fontWeight: FontWeight.w600)),
            ...
            Expanded(
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Mahalle, cadde, ilçe, il',
                ),
          ...
          children: [
            Expanded(
              child: TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Enlem (lat)', border: OutlineInputBorder()),
            ...
            Expanded(
              child: TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Boylam (lng)', border: OutlineInputBorder()),
                keyboardType: const TextInputType.numberWithOptions(decimal: true, signed: true),
                onChanged: (v) {
                  final parsed = double.tryParse(v.replaceAll(',', '.'));
                  if (parsed != null) {
