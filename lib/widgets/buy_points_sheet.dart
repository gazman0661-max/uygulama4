...
/// FORM/AI kotalarının aksine ayın 1'inde SIFIRLANMAZ, iki havuz da bittiğinde
...
/// yakalanacak).
Future<void> showBuyPointsSheet(BuildContext context) {
  ...
  Future<void> _buy(String productId, int amount) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(en ? '$amount points added ✅' : '$amount puan eklendi ✅')),
      );
    } catch (e) {
      if (!mounted) return;
      setState(() {
