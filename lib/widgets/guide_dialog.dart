...
const List<_GuideStep> _guideSteps = [
  ...
  _GuideStep(
    ...
    description:
        ...
        'yeniden satın alma gerektirir. Bu satın alma hesabınıza ayrıca '
        '+1 ek site yayın hakkı ekler. Domain paketi de aynı premium '
        'özellikleri açar (Google İşletme Profili Kurulum Sihirbazı dahil).',
  ),
  _GuideStep(
    emoji: '📋',
    accent: AppColors.accentBlue,
  ...
  // 20.09.2026 eklendi (kanka isteği) — sitemap.xml/robots.txt HERKESTE
  // (ücretsiz plan dahil) zaten otomatik; bunu kullanıcıya AÇIKÇA
  // yazıyoruz ki "Google'da çıkma" konusunda tereddüt yaşayan kullanıcılar
  // çekilsin (bkz. sohbet: "bu yöntemle kullanıcı çekeriz").
  _GuideStep(
    emoji: '🗺️',
    accent: AppColors.accentGreenLink,
    title: '12. Siten Google\'ın Bulabileceği Şekilde Hazır (Ücretsiz)',
    description:
  ...
  _GuideStep(
    emoji: '✅',
    accent: AppColors.accentPurple,
    title: '13. Google Search Console\'a Bağlan',
    description:
        'Abonelik veya özel domain paketi olan sitelerde (ücretsiz planda '
