...
const List<_GuideStep> _guideSteps = [
  ...
  // 05.09.2026 eklendi (kanka isteği) — Mağaza'ya eklenen "Kendi Domain
  // Bağla" ve "1 Aylık Mini Paket" satın almalarının hangi özellikleri
  // açtığı ve bunları kullanmak için ne yapılması gerektiği kılavuzda da
  // açıkça anlatılsın.
  _GuideStep(
    emoji: '🔓',
    accent: AppColors.accentPurple,
    title: '6. Premium Özellikler (Domain / Mini Paket)',
    description:
        'Mağaza\'dan \'Kendi Domain Bağla\' (1 yıllık) ya da \'1 Aylık Mini '
        'Paket\' satın alarak rozeti kaldırabilir; Talep Kutusu, tam '
        'galeri, harita, talep formu, Google yorum butonu ve ziyaretçi '
        'sayısını açabilirsiniz. Açılan bu özellikleri kullanmak için '
        'ilgili siteyi Projelerim ekranından \'DÜZENLE\' butonuyla açıp '
        'formu güncellemeniz gerekir.',
  ),
];
