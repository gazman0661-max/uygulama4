...
class _RemoveWatermarkSheetState extends State<_RemoveWatermarkSheet> {
  ...
  /// 03.09.2026 eklendi — kullanıcının Kutu'dan (hediye) biriktirdiği
  /// "watermark kaldırma hakkı" bakiyesi varsa ödeme yerine bunu harcar.
  /// bkz. AppState.redeemGiftWatermarkRemoval dokümantasyonu.
  ...
  /// Diğer satın alma sheet'leriyle (store_sheet.dart,
