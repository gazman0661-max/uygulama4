...
/// popup'ı. [quota_limit_popup.dart]'taki popup'la GÖRSEL OLARAK aynı
/// kalıbı (emoji + başlık + mesaj + tek buton) kullanır, tutarlılık için.
///
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              message ??
                  (en
                      ? 'This feature is only available on the Premium (custom domain) plan.'
                      : 'Bu özellik sadece Premium (özel domain) planında kullanılabilir.'),
              textAlign: TextAlign.center,
              style: const TextStyle(
