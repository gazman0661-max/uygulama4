          ...
          children: [
            ...
            Text(
              isRenewal
                  ...
                  : (en
                      ? '"$name" gets its own domain for 1 year with this purchase — one-time, applies ONLY to this site. This is a one-time purchase, NOT an auto-renewing subscription — it will NOT renew or charge you again by itself; you must come back and buy it again to extend. The "Made with Sitora" badge is removed permanently (stays removed even later). Other premium features (lead inbox, full gallery, map, lead form, Google review button, visitor stats) unlock for as long as the domain stays connected — extending before it expires requires this SAME purchase again, and if it lapses for more than 7 days the connection is fully released and this purchase must be made again to reconnect.'
                      : '"$name" bu satın almayla 1 yıllığına kendi domainine kavuşur — tek seferlik, SADECE bu site için geçerlidir. Bu tek seferlik bir satın almadır, OTOMATİK YENİLENEN bir abonelik DEĞİLDİR — kendiliğinden yenilenmez, tekrar ücret kesmez; süresi dolmadan uzatmak istersen tekrar senin satın alman gerekir. "Sitora ile üretildi" rozeti kalıcı olarak kaldırılır (daha sonra da geri gelmez). Diğer premium özellikler (Talep Kutusu, tam galeri, harita, talep formu, Google yorum butonu, ziyaretçi sayısı) domain bağlı kaldığı sürece açık kalır — süresi dolmadan uzatmak için AYNI satın almayı tekrar yapman gerekir, 7 günden fazla yenilenmezse bağlantı tamamen sökülür ve tekrar bağlamak için bu satın almayı yeniden yapman gerekir.'),
              style: const TextStyle(
