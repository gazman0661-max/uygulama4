            ...
            Flexible(
              child: ListView.separated(
                ...
                itemBuilder: (_, i) => _ExampleCard(
                  item: _examples[i],
                  onTap: () {
                    // ÖNEMLİ: Kartın kendisi t(context, item.prompt) ile
                    // ekranda doğru dilde gösteriliyor ama önceden burada
                    // ham (her zaman Türkçe) _examples[i].prompt sohbet
                    // kutusuna yazılıyordu — bu yüzden İngilizce modda bile
                    // kutuya Türkçe metin düşüyordu. Aynı çeviriyi burada da
                    // uygulayıp gösterilenle gönderileni tutarlı hale
                    // getiriyoruz.
                    onPick(t(ctx, _examples[i].prompt));
