...
void main() async {
  // Uygulamanın tüm ekranları (sohbet balonları, Builder Pro'nun 9:17
  // oranlı canvas'ı, alt tutamaç/panel çubukları) portre moda göre
  // tasarlandı ve test edildi. Yatay moda hiç kilit yoktu; döndürme
  // sırasında canvas oranı ve alt sabit çubuklar garip görünebiliyordu.
