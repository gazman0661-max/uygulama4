...
class AppStrings {
  ...
  static const Map<String, String> en = <String, String>{
    ...
    'Bu site formdan düzenlenemiyor.': 'This site can\'t be edited from the form.',
    'Dikey': 'Vertical',
    'Domain': 'Domain',
    'Doğruladım, kontrol et': 'I verified it, check now',
    'Gelen kutuna bir doğrulama bağlantısı gönderdik. Linke tıklayıp buraya döndüğünde otomatik devam edeceğiz — başka bir şey yapmana gerek yok.':
        'We sent a verification link to your inbox. Click it and come back here — we\'ll continue automatically, no need to do anything else.',
    'Henüz doğrulanmamış görünüyor. E-postanı kontrol et.': 'It doesn\'t look verified yet. Check your email.',
    ...
    'Satın aldığın puanlar ayın sonunda sıfırlanmaz; aylık ücretsiz kotan bittiğinde otomatik kullanılır.':
        'Points you purchase don\'t reset at the end of the month; they\'re used automatically once your monthly free quota runs out.',
    'Sektörüne özel bir şablon bulamadıysan (kırtasiye, bakkal, kuyumcu, optik, züccaciye vb.) bu genel şablonu kullanabilirsin.':
        'If you couldn\'t find a template specific to your sector (stationery, grocery, jewelry, optician, hardware store, etc.), you can use this general template.',
    'Sitenin ziyaretçiye görüneceği dil. Bu uygulamanın kendi arayüz dilinden bağımsızdır.':
        'The language visitors will see your site in. This is independent of this app\'s own interface language.',
    ...
    'Ücretsiz yayın hakkın doldu': 'Your free publish has been used',
