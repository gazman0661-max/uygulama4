...
class AppStrings {
  ...
  static const Map<String, String> en = <String, String>{
    ...
    '2023 - Freelance Fotoğrafçı - İstanbul\n2020 - Fotoğrafçılık Sertifikası - Kurs': '2023 - Freelance Photographer - Istanbul\n2020 - Photography Certificate - Course',
    '2023 - Freelance Makyaj Sanatçısı - İstanbul\n2021 - Makyaj Sertifikası - Akademi': '2023 - Freelance Makeup Artist - Istanbul\n2021 - Makeup Certificate - Academy',
    '2023 - Kişisel Antrenör - Freelance\n2020 - Fitness Eğitmenliği Sertifikası - Federasyon': '2023 - Personal Trainer - Freelance\n2020 - Fitness Instructor Certificate - Federation',
    '2023 - UI/UX Tasarımcı - Freelance\n2020 - Grafik Tasarım - Üniversite': '2023 - UI/UX Designer - Freelance\n2020 - Graphic Design - University',
    'Aile Danışmanlığı\nBireysel Terapi': 'Family Counseling\nIndividual Therapy',
    'Ana Sayfa': 'Home',
    'Aylık Üyelik - 1200 TL\nGrup Dersi (tekli) - 150 TL': 'Monthly Membership - 1200 TL\nGroup Class (single) - 150 TL',
    'Aşı & Kontrol\nCerrahi Operasyon\nMikroçip': 'Vaccination & Checkup\nSurgical Operation\nMicrochip',
    'B Sınıfı Ehliyet Kursu - 8 hafta - 12000 TL\nDireksiyon Ek Ders - 45 dk - 400 TL': 'Class B Driving Course - 8 weeks - 12000 TL\nExtra Driving Lesson - 45 min - 400 TL',
    'Başlangıçlar\nMercimek Çorbası - - 90 TL\nÇoban Salata - - 110 TL\n\nAna Yemekler\nIzgara Köfte - - 280 TL': "Starters\nLentil Soup - - 90 TL\nShepherd's Salad - - 110 TL\n\nMain Courses\nGrilled Meatballs - - 280 TL",
    'Ekmekler\nEkşi Mayalı Somun - 900g - 90 TL\nTam Buğday - 700g - 70 TL\n\nPastalar\nÇikolatalı Pasta - 8 Dilim - 350 TL': 'Breads\nSourdough Loaf - 900g - 90 TL\nWhole Wheat - 700g - 70 TL\n\nCakes\nChocolate Cake - 8 Slices - 350 TL',
    'Elektrik Arıza - 300 TL\nTesisat Tamiri - 350 TL': 'Electrical Fault - 300 TL\nWiring Repair - 350 TL',
    'Ev Temizliği - 3 saat - 500 TL\nOfis Temizliği - 800 TL': 'Home Cleaning - 3 hours - 500 TL\nOffice Cleaning - 800 TL',
    'Evden Eve Nakliyat - 2500 TL\nOfis Taşıma - 3500 TL': 'House Moving - 2500 TL\nOffice Relocation - 3500 TL',
    'Gelin Buketi - 800 TL\nAynı Gün Teslimat - 150 TL': 'Bridal Bouquet - 800 TL\nSame-Day Delivery - 150 TL',
    'Google Yorum Linki (opsiyonel)': 'Google Review Link (optional)',
    'Instagram - https://instagram.com/kullanici\nYoutube - https://youtube.com/@kanal': 'Instagram - https://instagram.com/username\nYoutube - https://youtube.com/@channel',
    "Instagram/TikTok bio'na koyacağın, tüm bağlantılarını tek sayfada toplayan mini site.": 'A mini site that gathers all your links on one page — perfect for your Instagram/TikTok bio.',
    'Kahveler\nEspresso - - 60 TL\nLatte - Sütlü - 75 TL\n\nTatlılar\nCheesecake - Ev yapımı - 90 TL': 'Coffees\nEspresso - - 60 TL\nLatte - With milk - 75 TL\n\nDesserts\nCheesecake - Homemade - 90 TL',
    'Kişiye Özel Beslenme Programı\nSporcu Beslenmesi\nOnline Danışmanlık': 'Personalized Nutrition Plan\nSports Nutrition\nOnline Consultation',
    'Kurşun Kalem - 15 TL\nDefter - 40 TL': 'Pencil - 15 TL\nNotebook - 40 TL',
    'Kutu': 'Mailbox',
    'Köpek Yıkama & Tıraş - 45 dk - 350 TL\nTırnak Kesimi - 100 TL': 'Dog Wash & Grooming - 45 min - 350 TL\nNail Trim - 100 TL',
    'Lastik Değişimi - 20 dk - 300 TL\nRot Balans - 45 dk - 500 TL': 'Tire Change - 20 min - 300 TL\nWheel Alignment - 45 min - 500 TL',
    'LinkedIn - https://linkedin.com/in/...\nWeb sitesi - https://...': 'LinkedIn - https://linkedin.com/in/...\nWebsite - https://...',
    'Manikür - 45 dk - 200 TL\nCilt Bakımı - 300 TL': 'Manicure - 45 min - 200 TL\nSkin Care - 300 TL',
    "Oturma Grubu - Modern Tasarım - 15000 TL'den başlayan\nYatak Odası Takımı - Ahşap - 25000 TL'den başlayan": 'Living Room Set - Modern Design - starting from 15000 TL\nBedroom Set - Wood - starting from 25000 TL',
    'Pantolon Paça Kısaltma - 100 TL\nElbise Dikim - 1500 TL': 'Trouser Hemming - 100 TL\nDress Tailoring - 1500 TL',
    'Pazartesi - 18:00 - CrossFit - Ahmet\nÇarşamba - 19:00 - Yoga - Elif': 'Monday - 18:00 - CrossFit - Ahmet\nWednesday - 19:00 - Yoga - Elif',
    'PhD - Klinik Psikoloji\nEMDR Sertifikası': 'PhD - Clinical Psychology\nEMDR Certificate',
    'Priz/Sigorta Arızası - 1 saat - 400 TL\nTesisat Yenileme - - Teklif üzerine': 'Outlet/Fuse Fault - 1 hour - 400 TL\nWiring Renewal - - Quote on request',
    'Projeler': 'Projects',
    'Saç Kesimi - 30 dk - 150 TL\nSakal Tıraşı - 100 TL': 'Haircut - 30 min - 150 TL\nBeard Trim - 100 TL',
    "Sitora'yı kullanmaya devam etmeden önce lütfen Gizlilik Politikası ve Kullanım Şartları'nı okuyup onaylayın.": 'Please read and accept the Privacy Policy and Terms of Use before continuing to use Sitora.',
    'Standart Oda - 2 Kişilik - 1500 TL\nSuit Oda - 4 Kişilik - 3000 TL': 'Standard Room - 2 People - 1500 TL\nSuite Room - 4 People - 3000 TL',
    'Talepler': 'Requests',
    'Tam Gün Bakım - 3-6 Yaş - 8500 TL/ay\nYarım Gün Bakım - 2-4 Yaş - 5500 TL/ay': 'Full-Day Care - Ages 3-6 - 8500 TL/month\nHalf-Day Care - Ages 2-4 - 5500 TL/month',
    'Ticaret Hukuku\nAile Hukuku\nİş Hukuku': 'Commercial Law\nFamily Law\nLabor Law',
    "Uzmanlık (örn. Düğün DJ'i)": 'Specialty (e.g. Wedding DJ)',
    "Ücretsiz aylık krediniz bitti. Puanlarınız her ayın 1'inde yenilenecek.": 'Your free monthly credit is used up. Your points will renew on the 1st of each month.',
    'İmplant Tedavisi\nDiş Beyazlatma\nOrtodonti': 'Implant Treatment\nTeeth Whitening\nOrthodontics',
    'İsveç Masajı - 60 dk - 600 TL\nAromaterapi - 90 dk - 900 TL': 'Swedish Massage - 60 min - 600 TL\nAromatherapy - 90 min - 900 TL',
    'İç-Dış Yıkama - 30 dk - 250 TL\nSeramik Kaplama - 1500 TL': 'Interior-Exterior Wash - 30 min - 250 TL\nCeramic Coating - 1500 TL',
    ...
    // === Kılavuz popup açıklamaları — 02.09.2026 eklendi ===
    "Form doldurarak site üretmek için ayda ücretsiz 15 puanınız var. Bu puanlar her ayın 1'inde 15'e YENİLENİR (biriktirmez, kullanmazsanız bir sonraki aya taşınmaz). Tek sayfa site 5 puan, çok sayfalı site 10 puan düşer.": "You have 15 free points per month to generate sites by filling out forms. These points RESET to 15 on the 1st of every month (they don't accumulate or carry over if unused). A single-page site costs 5 points, a multi-page site costs 10 points.",
    'Form gönderildiğinde siteniz otomatik olarak önizleme ekranında açılır; burada nasıl görüneceğini anında test edebilirsiniz.': 'Once you submit the form, your site automatically opens in the preview screen, where you can instantly test how it looks.',
    "Önizleme ekranındaki 'YAYINLA' butonuyla siteniz kendi alt alan adınızda (veya bağladığınız domainde) canlıya alınır.": "The 'PUBLISH' button on the preview screen puts your site live on your own subdomain (or the domain you've connected).",
    "Önizleme ekranındaki 'DÜZENLE' butonuyla formunuz, daha önce girdiğiniz bilgilerle DOLU şekilde tekrar açılır. Değişikliklerinizi yapıp 'DÜZENLEMEYİ BİTİR'e bastığınızda site güncellenir ve önizlemeye dönersiniz; her düzenleme sabit 2 puan düşer (tek/çok sayfa farketmez).": "The 'EDIT' button on the preview screen reopens your form already FILLED with the information you entered before. Make your changes and tap 'FINISH EDITING' — the site updates and you return to the preview; each edit costs a flat 2 points (single or multi-page, same cost).",
    "'İNDİR' butonuna bastığınızda cihazınızın kayıt penceresi açılır; dosya adını değiştirebilir ve kaydedilecek konumu kendiniz seçebilirsiniz.": "When you tap 'DOWNLOAD', your device's save dialog opens; you can change the file name and choose where to save it yourself.",
  };
}
