...
class AppStrings {
  ...
  static const Map<String, String> en = <String, String>{
    ...
    'Sitenin ziyaretçiye görüneceği dil. Bu uygulamanın kendi arayüz dilinden bağımsızdır.': 'The language your site will be shown in to visitors. This is independent of the app\'s own interface language.',
    'Sektörüne özel bir şablon bulamadıysan (kırtasiye, bakkal, kuyumcu, optik, züccaciye vb.) bu genel şablonu kullanabilirsin.': 'If you couldn\'t find a template specific to your sector (stationery, grocery, jeweler, optician, houseware, etc.), you can use this general-purpose template.',
    'Hesabın yok mu? Kayıt Ol': 'Don\'t have an account? Sign Up',
    'Bildirimin bize ulaştı, teşekkürler! En kısa sürede inceleyeceğiz. 🙏': 'Your report has reached us, thank you! We\'ll review it as soon as possible. 🙏',
    'Ücretsiz yayın hakkın doldu': 'Your free publish credit is used up',
    'Satın aldığın puanlar ayın sonunda sıfırlanmaz; aylık ücretsiz kotan bittiğinde otomatik kullanılır.': 'Points you purchase don\'t reset at the end of the month; they\'re used automatically once your monthly free quota runs out.',
    ...
    // 26.08.2026 eklendi — reklamlar (bkz. widgets/rewarded_ad_popup.dart).
    'İndirmek için kısa 1 reklam izle': 'Watch a short ad to download',
    'Yayınlamak için kısa 1 reklam izle': 'Watch a short ad to publish',
  };
}
