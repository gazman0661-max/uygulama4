...
class AppStrings {
  ...
  static const Map<String, String> en = <String, String>{
    ...
    'Form doldurarak site üretmek için ayda ücretsiz 30 puanınız var. '
        'Bu puanlar her ayın 1\'inde 30\'a YENİLENİR (biriktirmez, '
        ...
        'You get 30 free points every month for generating sites via the '
            'form. These points RESET to 30 on the 1st of every month '
