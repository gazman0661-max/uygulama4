...
class AppStrings {
  ...
  static const Map<String, String> en = <String, String>{
    ...
    // === Bölüm Sırası — Sürükle-Bırak (05.09.2026, kanka isteği) ===
    'Ana Sayfa Bölüm Sırası': 'Homepage Section Order',
    'Anasayfadaki bölümleri sürükleyerek istediğin sıraya getirebilirsin.':
        'Drag the sections on the homepage to reorder them.',
    'İlan Detay Sayfası Bölüm Sırası': 'Listing Detail Page Section Order',
    'Her ilanın kendi sayfasındaki bölüm sırası — tüm ilanlar için ortaktır.':
        'The section order on each listing\'s own page — shared across all listings.',
    'Sürükleyerek sırayı değiştirebilirsin.': 'Drag to change the order.',
    'Üst Tanıtım Alanı': 'Top Banner',
    'Google Yorum Butonu': 'Google Review Button',
    'İlan Listesi': 'Listing List',
    'Müşteri Yorumları': 'Customer Testimonials',
    'Sık Sorulan Sorular': 'Frequently Asked Questions',
    'İlan Bilgileri (Fiyat/m²/Oda)': 'Listing Details (Price/m²/Rooms)',
    'Harita/Konum': 'Map/Location',
    'İletişim / Talep Kutusu': 'Contact / Lead Form',
  };
}
