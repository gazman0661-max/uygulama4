...
/// Konum/çalışma saati yok (portfolyo sitesinde anlamsız); iletişim artık
/// Talep Kutusu (contactBlockHtml > leadFormMarkup) üzerinden çözülüyor —
/// 05.09.2026'dan önce burada mailto tabanlı contactFormBlockHtml
/// kullanılıyordu (kanka isteğiyle kaldırıldı, bkz. DEGISIKLIKLER_05_09_2026.md).
class PortfolioFormScreen extends StatefulWidget {
  const PortfolioFormScreen({super.key, this.initialMultiPage = false, this.initialData, this.isEditing = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Portfolyo Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Portfolyo Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(labelText: t(context, 'Meslek / unvan'), border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            TextField(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, 'Figma, UI Tasarım, Flutter'),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, '2023 - UI/UX Tasarımcı - Freelance\n2020 - Grafik Tasarım - Üniversite'),
                border: OutlineInputBorder(),
              ),
            ),
            const SizedBox(height: 20),
            GalleryPickerField(
              label: t(context, 'İş Örnekleri'),
