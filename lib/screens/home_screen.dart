...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _loadMessages();
    // NOT: Dil seçimi / yasal onay (KVKK vb.) zorunlu popup'ları artık
    // ANA EKRAN olan QuickToolsScreen'in initState'inde tetikleniyor
    // (bkz. quick_tools_screen.dart) — Hızlı Araçlar artık splash'tan
    // sonra açılan ilk ekran olduğu için taşındı. Burada TEKRAR
    // göstermiyoruz.
  }
  ...
  /// Hızlı Araçlar artık uygulamanın ANA ekranı (bkz. splash_screen.dart);
  /// bu ekran (AI Sohbet) oraya push edilerek açılıyor. Bu yüzden bu
  /// buton öncelikle geri dönsün (pop) — sadece bir şekilde stack'te
  /// Hızlı Araçlar yoksa (örn. ileride başka bir yerden AI Sohbet'e
  /// doğrudan girilirse) yedek olarak yeniden açar.
