...
/// ve metinler Müzisyen / DJ Sitesi için özelleştirildi.
class MusicianDjFormScreen extends StatefulWidget {
  const MusicianDjFormScreen({super.key, this.initialMultiPage = false, this.initialData, this.isEditing = false});
  ...
  @override
  State<MusicianDjFormScreen> createState() => _MusicianDjFormScreenState();
}

class _MusicianDjFormScreenState extends State<MusicianDjFormScreen> {
  ...
  Future<void> _openAiFillDialog() async {
    final result = await showAiFillDialog(
      context: context,
      sectorLabel: t(context, 'Müzisyen / DJ'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Müzisyen / DJ Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Müzisyen / DJ Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(labelText: t(context, "Uzmanlık (örn. Düğün DJ'i)"), border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            TextField(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, 'Düğün Organizasyonu, Canlı Performans, Ses Sistemi'),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, '2023 - Freelance DJ - İstanbul\n2019 - Müzik Yapımcılığı - Eğitim'),
                border: OutlineInputBorder(),
              ),
            ),
            const SizedBox(height: 20),
            GalleryPickerField(
              label: t(context, 'Performans Örnekleri'),
