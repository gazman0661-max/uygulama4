...
class _PersonalTrainerFormScreenState extends State<PersonalTrainerFormScreen> {
  ...
  Future<void> _generate() async {
    if (_nameCtrl.text.trim().isEmpty || _emailCtrl.text.trim().isEmpty) {
      showAppPopup(context, message: t(context, 'İsim ve e-posta gerekli.'), icon: '⚠️');
      return;
    }
        ...
        child: ListView(
          ...
          children: [
            ...
            GoogleReviewLinkField(
              ...
              gbp: () => GbpPrefill(
                name: _nameCtrl.text.trim(),
                categoryTr: 'Kişisel antrenör',
                categoryEn: 'Personal trainer',
              ),
            ),
            const SizedBox(height: 12),
            TextField(
            ...
            // kPortfolioDefaultOrder tek/çok sayfada AYNI (bkz. section_registry.dart).
            SectionOrderField(
