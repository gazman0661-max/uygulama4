...
class _FitnessFormScreenState extends State<FitnessFormScreen> {
  ...
  Future<void> _generate() async {
    if (_nameCtrl.text.trim().isEmpty || _phoneCtrl.text.trim().isEmpty) {
      showAppPopup(context, message: t(context, 'Stüdyo adı ve telefon gerekli.'), icon: '⚠️');
      return;
    }
    ...
    final ok = await LocalGenerationHelper.generateSinglePage(
      ...
      buildHtml: () => generateExtendedBusinessSiteHtml(
        ...
        logoUrl: _logo.isNotEmpty && (_logo.first['url'] ?? '').isNotEmpty ? _logo.first['url'] : null, // 17.09.2026 eklendi
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            SectionOrderField(
              defaultSectionIds: kExtendedBusinessDefaultOrder,
