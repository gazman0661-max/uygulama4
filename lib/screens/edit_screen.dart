...
class _EditScreenState extends State<EditScreen> {
  ...
  Future<void> _sendAiEdit(String request) async {
    ...
    if (!await appState.ensureAiQuotaFor(AppState.costEdit)) {
    ...
    // Worker'daki "full_edit" tipi diff-tabanlı prompt kullanır.
    setState(() => _aiBusy = true);
    try {
      final currentCode = _readCurrentCode(appState);
      final updated = await WorkerService.editFullCode(
