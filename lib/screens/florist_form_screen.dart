...
/// ve metinler Çiçekçi Sitesi için özelleştirildi.
class FloristFormScreen extends StatefulWidget {
  const FloristFormScreen({super.key, this.initialData, this.isEditing = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Çiçekçi Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Çiçekçi Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: t(context, 'Ürün/Hizmetler (her satıra bir tane: Ad - Süre - Fiyat)'),
                hintText: t(context, 'Gelin Buketi - 800 TL\nAynı Gün Teslimat - 150 TL'),
