...
class _TemplatePreviewScreenState extends State<TemplatePreviewScreen> {
  ...
  // 07.09.2026 eklendi (kanka isteği) — hero düzeni artık burada da (Kuaför
  // dahil TÜM sektörlerin ön izlemesinde) canlı denenebiliyor, bkz.
  // widget.config.showLayoutStyle/initialLayoutStyle.
  ...
  /// 06.09.2026 eklendi (kanka isteği) — preview_screen.dart'taki AYNI
  /// mantık: bu ekran salt demo olduğu için hiçbir sayfa içi link yok,
  /// ama demo verideki WhatsApp/telefon/harita gibi DIŞ linkler yine de
  /// tıklanınca önizlemeden çıkılmasın diye engelleniyor.
...
""";
    try {
      ...
      // Kritik değil: engelleme başarısız olsa bile önizleme yine görünür.
    }
  }
