      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            // Google İşletme Profili'ndeki "yorum yaz" linki (örn.
            // https://g.page/r/xxxxx/review). Doluysa sitede diğer iletişim
            // butonlarının yanına bir "Bizi Google'da Değerlendirin" butonu
            // eklenir (bkz. contactBlockHtml).
            ...
            // (ek sayfalar/multiPage nav'ı bu kapsamda DEĞİL, sadece
            // index.html'in orta blokları).
            SectionOrderField(
