          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                child: Text(
                  isEnglish(context)
                      ? 'Each QR generation costs ${AppState.costSinglePage} points · Remaining: ${appState.formCredits + appState.purchasedPoints + appState.giftPoints}'
                      : 'Her QR oluşturma ${AppState.costSinglePage} puan düşer · Kalan: ${appState.formCredits + appState.purchasedPoints + appState.giftPoints}',
