...
class _BusinessCardFormScreenState extends State<BusinessCardFormScreen> {
  ...
  // 18.09.2026 eklendi (kanka isteği) — bkz. typography_picker_field.dart
  // dokümanı; diğer sektör formlarıyla BİREBİR AYNI 3 alan.
  String _fontPackageId = 'modern_sade';
  Map<String, String>? _customFontPackage; // 'Serbest Font Seçimi' (PREMİUM)
