    ...
    Future.delayed(const Duration(milliseconds: 3500), () {
      ...
      Navigator.of(context).pushReplacement(
        PageRouteBuilder(
          ...
          // Ana ekran artık tek bir HomeScreen: üst paneldeki ANA SAYFA /
          // AI SOHBET butonuyla, ekran değişmeden Hızlı Araçlar listesi ile
          // AI sohbet akışı arasında geçiş yapılıyor (bkz. home_screen.dart).
