...
///
/// NOT: Bu paket adı, bu sohbet uygulamasını kendi başına yayınlarken
/// kendi Play Store applicationId'nizle güncellenmelidir (bkz. README.md).
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  /// WorkerService fonksiyonunu (generateSiteCode / generateMultiPageSite)
  ...
  /// İkinci satır: Kılavuz / Örnekler / Puan Ver / elmas sayacı.
  ///
  ...
  Widget _buildCreditChip(AppState appState) {
    final current = appState.aiCredits;
    final max = AppState.maxAiPoints;
    return Container(
      height: 38,
