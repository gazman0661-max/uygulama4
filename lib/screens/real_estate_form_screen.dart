...
class _RealEstateFormScreenState extends State<RealEstateFormScreen> {
  ...
  Future<void> _openAiFillDialog() async {
    final result = await showAiFillDialog(
      context: context,
      sectorLabel: t(context, 'Emlak'),
      initialCompanyName: _agentNameCtrl.text,
    ...
    setState(() {
      if (result['companyName'] != null) _agentNameCtrl.text = result['companyName']!;
      ...
      if (result['description'] != null) _descriptionCtrl.text = result['description']!;
