...
/// ve metinler Terzi Sitesi için özelleştirildi.
class TailorFormScreen extends StatefulWidget {
  const TailorFormScreen({super.key, this.initialData, this.isEditing = false});
  ...
  @override
  State<TailorFormScreen> createState() => _TailorFormScreenState();
}

class _TailorFormScreenState extends State<TailorFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Terzi Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Terzi Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, 'Pantolon Paça Kısaltma - 100 TL\nElbise Dikim - 1500 TL'),
