...
/// ve metinler Anaokulu / Kreş için özelleştirildi.
class KindergartenFormScreen extends StatefulWidget {
  const KindergartenFormScreen({super.key, this.initialData, this.isEditing = false});
  ...
  @override
  State<KindergartenFormScreen> createState() => _KindergartenFormScreenState();
}

class _KindergartenFormScreenState extends State<KindergartenFormScreen> {
  ...
  Future<void> _openAiFillDialog() async {
    final result = await showAiFillDialog(
      context: context,
      sectorLabel: t(context, 'Anaokulu / Kreş'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Anaokulu / Kreş Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Anaokulu / Kreş Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: t(context, 'Programlar (her satıra bir tane: Ad - Yaş Grubu - Ücret)'),
                hintText: t(context, 'Tam Gün Bakım - 3-6 Yaş - 8500 TL/ay\nYarım Gün Bakım - 2-4 Yaş - 5500 TL/ay'),
