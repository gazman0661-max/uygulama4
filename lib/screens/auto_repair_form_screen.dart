...
/// ve metinler Oto Tamirci / Lastikçi için özelleştirildi.
class AutoRepairFormScreen extends StatefulWidget {
  const AutoRepairFormScreen({super.key, this.initialData, this.isEditing = false});
  ...
  @override
  State<AutoRepairFormScreen> createState() => _AutoRepairFormScreenState();
}

class _AutoRepairFormScreenState extends State<AutoRepairFormScreen> {
  ...
  Future<void> _openAiFillDialog() async {
    final result = await showAiFillDialog(
      context: context,
      sectorLabel: t(context, 'Oto Tamirci / Lastikçi'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Oto Tamirci / Lastikçi Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Oto Tamirci / Lastikçi Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, 'Lastik Değişimi - 20 dk - 300 TL\nRot Balans - 45 dk - 500 TL'),
