...
/// ve metinler Elektrikçi için özelleştirildi.
class ElectricianFormScreen extends StatefulWidget {
  const ElectricianFormScreen({super.key, this.initialData, this.isEditing = false});
  ...
  @override
  State<ElectricianFormScreen> createState() => _ElectricianFormScreenState();
}

class _ElectricianFormScreenState extends State<ElectricianFormScreen> {
  ...
  Future<void> _openAiFillDialog() async {
    final result = await showAiFillDialog(
      context: context,
      sectorLabel: t(context, 'Elektrikçi'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Elektrikçi Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Elektrikçi Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: t(context, 'Priz/Sigorta Arızası - 1 saat - 400 TL\nTesisat Yenileme - - Teklif üzerine'),
