...
class PreviewScreen extends StatefulWidget {
  ...
  /// false (varsayılan) ise AI Chat'in kendi slotunu gösterir. İkisi
  /// birbirinden tamamen bağımsızdır — bkz. AppState qtGeneratedCode/
  /// qtGeneratedFiles.
  final bool isQuickTools;
  const PreviewScreen({super.key, this.isQuickTools = false});
