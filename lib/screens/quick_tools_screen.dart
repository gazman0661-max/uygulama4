...
/// havuzundan düşer (AppState.costSinglePage = 5 puan, aylık 15 puan
...
class _QuickToolsScreenState extends State<QuickToolsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(t(context, 'Sitora'))),
      body: ListView(
        ...
        children: [
          ...
          _ToolCard(
            ...
            subtitle: t(context, 'Sektörüne özel bir şablon yoksa: hem tek hem çok sayfa, tema ve dil seçenekli genel işletme sitesi.'),
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => const GenericBusinessFormScreen()),
            ),
          ),
