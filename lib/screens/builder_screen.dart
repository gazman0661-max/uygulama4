...
class _BuilderScreenState extends State<BuilderScreen> with WidgetsBindingObserver {
  ...
  /// 26.08.2026 eklendi — İNDİRMEDEN ÖNCE rewarded reklam onay popup'ı (bkz.
  /// widgets/rewarded_ad_popup.dart). _persistToProjects() ÖNCE çağrılır ki
  /// canvas boşsa kullanıcı boşuna reklam izlemesin — kendi hata mesajını
  /// zaten gösteriyor (bkz. aşağıdaki null kontrolü).
