...
/// ve metinler Butik Otel / Pansiyon için özelleştirildi.
class BoutiqueHotelFormScreen extends StatefulWidget {
  const BoutiqueHotelFormScreen({super.key, this.initialData, this.isEditing = false});
  ...
  @override
  State<BoutiqueHotelFormScreen> createState() => _BoutiqueHotelFormScreenState();
}

class _BoutiqueHotelFormScreenState extends State<BoutiqueHotelFormScreen> {
  ...
  Future<void> _generate() async {
    ...
    final ok = await LocalGenerationHelper.generateSinglePage(
      ...
      kind: ProjectKind.boutiqueHotel,
      formData: formData,
  ...
  Future<void> _openAiFillDialog() async {
    final result = await showAiFillDialog(
      context: context,
      sectorLabel: t(context, 'Butik Otel / Pansiyon'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.isEditing
              ? '${t(context, 'Butik Otel / Pansiyon Sitesi')} • ${t(context, 'Düzenle')}'
              : t(context, 'Butik Otel / Pansiyon Sitesi'),
        ),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: t(context, 'Oda Tipleri (her satıra bir tane: Ad - Kapasite - Gecelik Fiyat)'),
                hintText: t(context, 'Standart Oda - 2 Kişilik - 1500 TL\nSuit Oda - 4 Kişilik - 3000 TL'),
