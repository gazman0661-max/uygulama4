...
class AuthService {
  ...
  /// gelen "Android client for com.sitora.ai" client_id'si — RELEASE
  /// build (Play Store'dan inen APK) için kullanılır.
  ///
  ...
  /// bile. Hem clientId (Android) hem serverClientId (Web) birlikte
  /// verildiğinde Credential Manager doğru client'a bağlanıyor ve bu
  /// sessiz-deneme hatası ortadan kalkıyor.
  static const String _androidClientIdRelease =
      '421106472212-pg72pj6761ssjo7l1cg5gs1km6clmc78.apps.googleusercontent.com';

  /// google-services.json içindeki, DEBUG keystore SHA-1'ine
  /// (b7:ce:b2:d4:2e:07:7b:fd:73:ce:57:85:ec:b3:54:d5:21:7a:4e:ac — CI'daki
  /// "Debug keystore SHA-1'ini logla (teşhis)" adımından doğrulandı)
  /// karşılık gelen Android client_id'si — DEBUG build için kullanılır.
  ///
  /// Aynı "Account reauth failed" glitch'i clientId olmadan debug build'de
  /// de çıktığı gözlemlendi (2 otomatik deneme sonrası bile kalıcıydı) —
  /// yani bu sorun sadece Play App Signing'e özgü değilmiş, Credential
  /// Manager'ın her build/sertifika için doğru clientId'yi istediği
  /// anlaşıldı. Bu yüzden debug'da da artık clientId veriliyor.
  ...
  Future<void> _ensureInitialized() async {
    ...
    // Build tipine göre doğru sertifikanın Android client'ı seçiliyor.
