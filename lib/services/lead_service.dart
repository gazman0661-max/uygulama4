...
/// okur. Yazma tarafı UYGULAMADAN DEĞİL, ziyaretçinin tarayıcısından
/// doğrudan Firestore REST API ile yapılıyor (bkz. o dosyadaki JS) — bu
/// yüzden burada sadece OKUMA var.
///
/// Firestore şeması:
///   leads/{leadId}
