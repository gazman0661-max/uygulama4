...
class DownloadService {
  ...
  static Future<File> saveSingleHtml({
    ...
    await Share.shareXFiles(
      ...
      text: isEnglish ? 'Made with Sitora 🚀' : 'Sitora ile üretildi 🚀',
    );
    return file;
  }
  ...
  static Future<File> saveMultiPageZip({
    ...
    await Share.shareXFiles(
      ...
      text: isEnglish
          ? 'Made with Sitora 🚀 — unzip it and upload to any hosting you like.'
          : 'Sitora ile üretildi 🚀 — zip\'i açıp istediğin hosting\'e yükleyebilirsin.',
    );
    return zipFile;
  }
