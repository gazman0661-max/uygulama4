...
class SubscriptionService {
  ...
  static Future<SubscriptionStatus?> fetchStatus(String uid) async {
    ...
    // GÜVENLİK (19.09.2026 değişti): worker artık uid'i ?uid= parametresinden
    // değil `Authorization: Bearer <Firebase ID Token>` header'ından okuyor
    // (bkz. worker > handleSubscriptionStatus). Giriş yoksa ya da giriş yapmış
    // hesap [uid] ile uyuşmuyorsa istek atılmaz — "bilinmiyor" (null): yerel
    // durum korunur.
