...
class WatermarkService {
  ...
  static String _badgeScript(bool isEnglish) {
    ...
    return '''
$_marker
<script>(function(){try{var bin=atob("$encoded");var bytes=new Uint8Array(bin.length);for(var i=0;i<bin.length;i++){bytes[i]=bin.charCodeAt(i);}var t=new TextDecoder("utf-8").decode(bytes);var d=document.createElement("div");d.textContent=t;d.style.cssText="position:fixed;bottom:10px;right:10px;z-index:999999;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1;background:rgba(17,17,17,.72);color:#fff;padding:6px 12px;border-radius:999px;pointer-events:none;user-select:none;box-shadow:0 2px 6px rgba(0,0,0,.25)";(document.body||document.documentElement).appendChild(d);}catch(e){}})();</script>''';
  }
