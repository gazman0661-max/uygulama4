    ...
    try {
      res = await http.delete(
        ...
        headers: {
          ...
          // bkz. DomainService.disconnect'teki AYNI gerekçe): owner_token'ı
          // olmayan eski siteler için worker artık sıkı modda bunu istiyor.
  ...
  static Future<void> unassignDomain({required String siteId, String? ownerToken}) async {
    ...
    try {
      res = await http.delete(
        ...
        headers: {
          if (ownerToken != null) 'x-owner-token': ownerToken,
          // GÜVENLİK (20.09.2026 eklendi) — bkz. unassign()'daki AYNI gerekçe.
          ...await authHeaderIfSignedIn(),
        },
      );
    } catch (e) {
