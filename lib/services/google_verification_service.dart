    ...
    try {
      res = await http.patch(
        ...
        headers: {
          ...
          // GÜVENLİK (20.09.2026 eklendi) — bkz. DomainService.disconnect'teki
          // AYNI gerekçe: owner_token'ı olmayan eski siteler için worker
          // artık sıkı modda giriş yapmış olmayı istiyor.
